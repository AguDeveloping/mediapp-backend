...
public class ConsultaServiceImpl extends CRUDImpl<Consulta, Integer> implements IConsultaService {
	...
	@Override
	public Consulta registrarTransaccional1(Consulta consulta) {
	...
	public Consulta registrarTransaccional(ConsultaListaExamenDTO dto) {
		...
		/**
		 * similar en java 6 o 7 List<DetalleConsulta> listaDetalle =
		 * consulta.getDetalleConsulta(); for(DetalleConsulta det : listaDetalle) {
